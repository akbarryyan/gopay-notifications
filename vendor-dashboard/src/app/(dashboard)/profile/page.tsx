...
/**
 * Profile vendor: sementara isinya cuma ganti password (dipindah dari
 * Settings, yang sekarang khusus pengaturan notifikasi ke customer).
 *
 * Sebelum ada halaman ini, SATU-SATUNYA cara ganti password vendor adalah
 * `go run ./cmd/admintool` di server. admintool tetap ada (bikin akun vendor
 * pertama kali / reset darurat kalau lupa password total), tapi ganti
 * password rutin tidak perlu terminal.
 */
      ...
      <div className="max-w-md">
        <Card className="rounded-2xl border-none shadow-sm ring-1 ring-border/60">
          <CardHeader>
            ...
            <CardDescription>Minimal 8 karakter. Password saat ini wajib diisi.</CardDescription>
          </CardHeader>
          <CardContent>
